    ...
    <div className="flex min-h-screen bg-background">
      <div className="hidden lg:flex w-1/2 bg-muted/30 items-center justify-center">
        <div className="max-w-md px-12">
          ...
          <div className="text-4xl font-bold glow-text mb-4">Welcome back</div>
          <div className="text-muted-foreground">Sign in to access your datasets, projects, and analytics.</div>
        </div>
      </div>
          ...
          <CardContent>
            <form onSubmit={handleEmailLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="m@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required className="bg-background/50" />
              </div>
              <div className="space-y-2">
